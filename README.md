...
and a file ~/Downloads/2014-05-06-12-54-54/vo/vo.csv should be downloaded, and extracted. A more thorough example is provided in the files datasets-custom.txt and file-patterns-custom.txt, capturing many datasets and a few different sensor types.
